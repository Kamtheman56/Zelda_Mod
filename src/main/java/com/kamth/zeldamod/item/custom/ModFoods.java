...
public class ModFoods {
    ...
    public static final FoodProperties BLUE = (new FoodProperties.Builder()).nutrition(20).saturationMod(12F).effect(new MobEffectInstance(MobEffects.HEAL, 10, 0), 1.0F).build();
}
