...
public class ModFoods {
    ...
    public static final FoodProperties SUPER_MUSHROOM = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.6F).fast().alwaysEat().effect(new MobEffectInstance(MobEffects.HEAL, 4, 0), 1.0F).build();
