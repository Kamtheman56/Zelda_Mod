...
public class DarknutHelmetModel extends HumanoidModel<LivingEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        .texOffs(28, 50).addBox(-1.0F, -20.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.F)), PartPose.offset(0.0F, 0F, 0.0F));

        PartDefinition extra = head.addOrReplaceChild("extra", CubeListBuilder.create().texOffs(32, 0).addBox(-9.0F, -34.0F, 1.0F, 4.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(32, 4).addBox(5.0F, -34.0F, 1.0F, 4.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(0, 32).addBox(0.0F, -39.0F, -3.0F, 0.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
