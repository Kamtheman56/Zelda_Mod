...
public class PegasusBootsModel extends HumanoidModel<LivingEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r1 = rightLeg.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(-3, -3).addBox(-2.32F, 7.0F, 1.3F, 0.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.9F, 12.0F, 0.0F));
        PartDefinition cube_r2 = leftLeg.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(-3, -3).addBox(2.32F, 7.0F, 1.3F, 0.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(1.9F, 12.0F, 0.0F));
