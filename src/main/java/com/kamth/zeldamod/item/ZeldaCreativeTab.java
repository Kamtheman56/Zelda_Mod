...
public class ZeldaCreativeTab {
    public static void addCreativeTabItems(BuildCreativeModeTabContentsEvent event) {
        ...
        if (event.getTab() == ModCreativeModeTab.ZELDA_TAB.get()){
            ...
            event.accept(ZeldaBlocks.SHEIKAH_TECH_BLOCK);
            ...
            event.accept(ZeldaBlocks.DEKU_FLOWER_WHITE);
            event.accept(ZeldaBlocks.DEKU_FLOWER_LIGHT_GRAY);
            event.accept(ZeldaBlocks.DEKU_FLOWER_GRAY);
            event.accept(ZeldaBlocks.DEKU_FLOWER_BLACK);
            event.accept(ZeldaBlocks.DEKU_FLOWER_BROWN);
            event.accept(ZeldaBlocks.DEKU_FLOWER_RED);
            event.accept(ZeldaBlocks.DEKU_FLOWER_ORANGE);
            event.accept(ZeldaBlocks.DEKU_FLOWER_GOLD);
            event.accept(ZeldaBlocks.DEKU_FLOWER_LIME);
            event.accept(ZeldaBlocks.DEKU_FLOWER_GREEN);
            event.accept(ZeldaBlocks.DEKU_FLOWER_TEAL);
            event.accept(ZeldaBlocks.DEKU_FLOWER_LIGHT_BLUE);
            event.accept(ZeldaBlocks.DEKU_FLOWER_BLUE);
            event.accept(ZeldaBlocks.DEKU_FLOWER_PURPLE);
            event.accept(ZeldaBlocks.DEKU_FLOWER_MAGENTA);
            event.accept(ZeldaBlocks.DEKU_FLOWER);
