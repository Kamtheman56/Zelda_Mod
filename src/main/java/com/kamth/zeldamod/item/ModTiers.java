...
public class ModTiers {
    public static final ForgeTier ZELDA = new ForgeTier(2, 0, 1.5f, 2f,
    ...
    public static final ForgeTier UNBREAKABLE = new ForgeTier(2, 0, 1.5f, 2f,
    ...
    public static final ForgeTier MASTER_SHARD = new ForgeTier(2, 59, 1.5f, 2f,
            3, BlockTags.NEEDS_IRON_TOOL,
            () -> Ingredient.of(ZeldaItems.MASTER_SHARD.get()));
}
