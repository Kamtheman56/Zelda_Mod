...
public class ReinforcedBowItem extends BowItem {
    ...
    public ReinforcedBowItem(Properties pProperties) {
        super(pProperties);
    }
    @Override
   ...
   @Override
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!pLevel.isClientSide) {
                        ...
                        abstractarrow.shootFromRotation(player, player.getXRot(), player.getYRot(), 0.0F, f * 3.2F, .8F);
                        if (f == 1.0F) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        ...
        else components.add(Component.translatable("item.reinforced_bow.description_basic").withStyle(ChatFormatting.YELLOW).withStyle(ChatFormatting.ITALIC));
