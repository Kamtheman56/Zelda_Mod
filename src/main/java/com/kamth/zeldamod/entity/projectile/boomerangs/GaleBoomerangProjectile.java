...
public class GaleBoomerangProjectile extends Projectile {
    ...
    public void tick() {
        ...
        if(!returning) {
            ...
            List<BombEntity> bomb = level().getEntitiesOfClass(BombEntity.class, getBoundingBox().inflate(2));
            ...
            for(BombEntity bombEntity : bomb) {
                if (bombEntity.isPassenger())
                    continue;
                bombEntity.startRiding(this);
            }
