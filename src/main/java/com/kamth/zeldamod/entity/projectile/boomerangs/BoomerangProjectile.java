...
public class BoomerangProjectile extends Projectile {
    ...
    private final ItemStack boomerangItem = new ItemStack(ZeldaItems.BOOMERANG.get());
    ...
    public BoomerangProjectile(EntityType<? extends Projectile> type, Level worldIn, LivingEntity throwerIn) {
        super(type, worldIn);
    ...
    protected void defineSynchedData() {
      entityData.define(STACK, new ItemStack(ZeldaItems.BOOMERANG.get()));
...
super.onHit(result);
    ...
    protected boolean canAddPassenger(@Nonnull Entity passenger) {
        return super.canAddPassenger(passenger) || passenger instanceof ItemEntity || passenger instanceof ExperienceOrb
                || passenger instanceof BombEntity;
    }
    ...
    public void readAdditionalSaveData(@Nonnull CompoundTag compound) {
        ...
        if (compound.contains(TAG_ITEM_STACK))
            ...
            setStack(new ItemStack(ZeldaItems.BOOMERANG.get()));
