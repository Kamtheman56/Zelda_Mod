...
public class BombchuEntity extends ThrowableProjectile {
    ...
    public BombchuEntity(EntityType<BombchuEntity> bombProjectileEntityType, Level level) {
        super(bombProjectileEntityType,level);

    }

    public BombchuEntity(Level world, LivingEntity owner) {
