...
//public static final EntityType<Arrow> ARROW = register("arrow", EntityType.Builder.<Arrow>of(Arrow::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20));
    ...
    public static final RegistryObject<EntityType<BombProjectile>> BOMB = ENTITY_TYPES.register("bomb", () -> Builder.<BombProjectile>of(BombProjectile::new, MobCategory.MISC).sized(0.5f,0.6f).clientTrackingRange(4).updateInterval(20).build(new ResourceLocation(ZeldaMod.MOD_ID, "bomb").toString()));
    ...
    public static final RegistryObject<EntityType<BoomerangProjectile>> BOOMERANG = ENTITY_TYPES.register("boomerang_projectile", () -> Builder.<BoomerangProjectile>of(BoomerangProjectile::new, MobCategory.MISC).sized(.6f,.7f).clientTrackingRange(6).updateInterval(20).build(new ResourceLocation(ZeldaMod.MOD_ID, "boomerang").toString()));
    ...
    public static final RegistryObject<EntityType<BombchuProjectile>> BOMBCHU = ENTITY_TYPES.register("bombchu", () -> Builder.<BombchuProjectile>of(BombchuProjectile::new, MobCategory.MISC).sized(0.5f,0.6f).clientTrackingRange(6).updateInterval(20).build(new ResourceLocation(ZeldaMod.MOD_ID, "bombchu").toString()));
    public static final RegistryObject<EntityType<KorokSeedProjectile>> KOROK_SEED = ENTITY_TYPES.register("korok_seed", () -> EntityType.Builder.<KorokSeedProjectile>of(KorokSeedProjectile::new, MobCategory.MISC).sized(0.7f,0.7f).clientTrackingRange(4).updateInterval(20).build(new ResourceLocation(ZeldaMod.MOD_ID, "korok_seed").toString()));
