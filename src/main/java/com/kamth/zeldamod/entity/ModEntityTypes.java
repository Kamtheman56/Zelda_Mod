...
//public static final EntityType<Arrow> ARROW = register("arrow", EntityType.Builder.<Arrow>of(Arrow::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20));
    ...
    public static final RegistryObject<EntityType<BombchuProjectile>> BOMBCHU = ENTITY_TYPES.register("bombchu", () -> Builder.<BombchuProjectile>of(BombchuProjectile::new, MobCategory.MISC).sized(0.5f,0.6f).clientTrackingRange(4).updateInterval(20).build(new ResourceLocation(ZeldaMod.MOD_ID, "bombchu").toString()));
