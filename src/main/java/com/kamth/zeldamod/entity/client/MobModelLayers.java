...
public class MobModelLayers {
    ...
    public static final ModelLayerLocation IRON_KNUCKLE_LAYER = new ModelLayerLocation(
            new ResourceLocation(ZeldaMod.MOD_ID, "iron_knuckle_layer"), "main");
    ...
    public static final ModelLayerLocation CHUCHU_OUTER_LAYER = new ModelLayerLocation(
            new ResourceLocation(ZeldaMod.MOD_ID, "chuchu_layer"), "outer");
