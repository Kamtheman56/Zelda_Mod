...
public class DarknutAttackGoal extends MeleeAttackGoal {
    public DarknutAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
