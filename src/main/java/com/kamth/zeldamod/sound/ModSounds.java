...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> SWORD_BEAM = registerSoundEvents("sword_beam");
    public static final RegistryObject<SoundEvent> SWORD_BEAM_SHATTERS = registerSoundEvents("sword_beam_shatters");
    ...
    public static final RegistryObject<SoundEvent> KOROK_CRUNCH = registerSoundEvents("korok_crunch");
