...
public class GripshotRender extends EntityRenderer<GripShot> {
    ...
    public GripshotRender(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    protected int getBlockLightLevel(GripShot pEntity, BlockPos pPos) {
        return 15;
    }

    public void render(GripShot pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(GripShot pEntity) {
