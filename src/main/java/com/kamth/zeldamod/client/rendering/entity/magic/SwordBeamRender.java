...
public class SwordBeamRender extends EntityRenderer<SwordBeam> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(ZeldaMod.MOD_ID, "textures/entity/projectiles/sword_beam.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public SwordBeamRender(EntityRendererProvider.Context pContext) {
        super(pContext);
    }
    ...
    public void render(SwordBeam pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(SwordBeam pEntity) {
