...
public class IceRender extends EntityRenderer<IceProjectile> {
    ...
    public IceRender(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    protected int getBlockLightLevel(IceProjectile pEntity, BlockPos pPos) {
        return 15;
    }

    public void render(IceProjectile pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(IceProjectile pEntity) {
