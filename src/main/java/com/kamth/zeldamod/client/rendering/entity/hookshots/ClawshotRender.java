package com.kamth.zeldamod.client.rendering.entity.hookshots;
...
public class ClawshotRender extends EntityRenderer<Clawshot> {
    ...
    public ClawshotRender(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    protected int getBlockLightLevel(Clawshot pEntity, BlockPos pPos) {
        return 15;
    }

    public void render(Clawshot pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(Clawshot pEntity) {
