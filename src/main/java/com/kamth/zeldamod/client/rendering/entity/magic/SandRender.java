...
public class SandRender extends EntityRenderer<SandProjectile> {
    ...
    public SandRender(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    protected int getBlockLightLevel(SandProjectile pEntity, BlockPos pPos) {
        return 15;
    }

    public void render(SandProjectile pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(SandProjectile pEntity) {
