...
public class FireRender extends EntityRenderer<FireProjectile> {
    ...
    public FireRender(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    protected int getBlockLightLevel(FireProjectile pEntity, BlockPos pPos) {
        return 15;
    }

    public void render(FireProjectile pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
