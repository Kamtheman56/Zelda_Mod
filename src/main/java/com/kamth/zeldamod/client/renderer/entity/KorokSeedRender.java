...
public class KorokSeedRender extends EntityRenderer<KorokSeedProjectile> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(ZeldaMod.MOD_ID, "textures/item/korok_seed.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public KorokSeedRender(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    protected int getBlockLightLevel(KorokSeedProjectile pEntity, BlockPos pPos) {
        return 15;
    }

    public void render(KorokSeedProjectile pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(KorokSeedProjectile pEntity) {
